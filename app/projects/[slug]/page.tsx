        ...
        <div className='overflow-hidden'>
          ...
          <div className="firstPart flex flex-col md:flex-row md:gap-8">
            ...
            <div className="md:w-1/2">
              <h1 className="text-2xl md:text-5xl font-light mb-4 text-white">Communicate class, distinction and art</h1>
          ...
          <div className="secondPart mt-16">
            <h1 className="text-2xl md:text-5xl font-light mb-4 text-white ">Italian excellence</h1>
